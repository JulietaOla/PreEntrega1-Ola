                        ...
                        <tbody>
                            {cart.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td className="align-middle text-end">USD: {item.quantity * item.precio}</td>
                                    <td className="align-middle text-end"><Link onClick={() => {removeItem(item.id)}} title={"Eliminar Producto"}><img src={"/images/icons8-trash-can.svg"} alt={"Eliminar Producto"} width={32} /></Link></td>
                                </tr>
                                ))
                            }
                            <tr>
                                ...
                                <td className="text-end"><b>USD: {sumTotal()}</b></td>
